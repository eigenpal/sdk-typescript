 ...
 */
export const automationsDatasetReviewRequestsList = <ThrowOnError extends boolean = false>(options: Options<AutomationsDatasetReviewRequestsListData, ThrowOnError>) => (options.client ?? client).get<AutomationsDatasetReviewRequestsListResponses, AutomationsDatasetReviewRequestsListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const automationsDatasetReviewRequestsCreate = <ThrowOnError extends boolean = false>(options: Options<AutomationsDatasetReviewRequestsCreateData, ThrowOnError>) => (options.client ?? client).post<AutomationsDatasetReviewRequestsCreateResponses, AutomationsDatasetReviewRequestsCreateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/automations/{id}/dataset-review-requests',
    ...options,
    headers: {
 ...
 */
export const automationsDatasetReviewRequestsGet = <ThrowOnError extends boolean = false>(options: Options<AutomationsDatasetReviewRequestsGetData, ThrowOnError>) => (options.client ?? client).get<AutomationsDatasetReviewRequestsGetResponses, AutomationsDatasetReviewRequestsGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const automationsDatasetReviewRequestsListEvents = <ThrowOnError extends boolean = false>(options: Options<AutomationsDatasetReviewRequestsListEventsData, ThrowOnError>) => (options.client ?? client).get<AutomationsDatasetReviewRequestsListEventsResponses, AutomationsDatasetReviewRequestsListEventsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const automationsDatasetReviewRequestsListItems = <ThrowOnError extends boolean = false>(options: Options<AutomationsDatasetReviewRequestsListItemsData, ThrowOnError>) => (options.client ?? client).get<AutomationsDatasetReviewRequestsListItemsResponses, AutomationsDatasetReviewRequestsListItemsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const automationsDatasetReviewRequestsItemFileGet = <ThrowOnError extends boolean = false>(options: Options<AutomationsDatasetReviewRequestsItemFileGetData, ThrowOnError>) => (options.client ?? client).get<AutomationsDatasetReviewRequestsItemFileGetResponses, AutomationsDatasetReviewRequestsItemFileGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const datasetReviewRequestsList = <ThrowOnError extends boolean = false>(options?: Options<DatasetReviewRequestsListData, ThrowOnError>) => (options?.client ?? client).get<DatasetReviewRequestsListResponses, DatasetReviewRequestsListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const runsStepsGet = <ThrowOnError extends boolean = false>(options: Options<RunsStepsGetData, ThrowOnError>) => (options.client ?? client).get<RunsStepsGetResponses, RunsStepsGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
